...
# Container DB (Lives inside the container, or APP_DATA_DIRECTORY locally)
_container_db_dir = os.getenv("APP_DATA_DIRECTORY", "/app")
container_db_url = f"sqlite+aiosqlite:///{_container_db_dir}/container.db"
