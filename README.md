...
Create AI-powered presentations using your own model provider (BYOK), run the full stack in Docker, and keep your data under your control.
...
### ⚡ Running Presenton
  ...
  <p>
    You can run Presenton with <strong>Docker</strong> for a one-command setup
    without installing a local development stack.
  </p>
...
These settings apply to Docker deployments. You may want to directly provide your API KEYS as environment variables and keep them hidden. You can set these environment variables to achieve it.
